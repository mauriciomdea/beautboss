class ConvertDatabaseToUtf8mb4 < ActiveRecord::Migration
  def change
    ...
    execute "ALTER TABLE places CONVERT TO CHARACTER SET utf8mb4 COLLATE utf8mb4_bin"
    ...
    execute "ALTER TABLE comments CHANGE comment comment VARCHAR(191) CHARACTER SET utf8mb4 COLLATE utf8mb4_bin"
    execute "ALTER TABLE places CHANGE name name VARCHAR(191) CHARACTER SET utf8mb4 COLLATE utf8mb4_bin"
    execute "ALTER TABLE posts CHANGE service service VARCHAR(191) CHARACTER SET utf8mb4 COLLATE utf8mb4_bin"
    execute "ALTER TABLE users CHANGE name name VARCHAR(191) CHARACTER SET utf8mb4 COLLATE utf8mb4_bin"
    execute "ALTER TABLE users CHANGE bio bio VARCHAR(191) CHARACTER SET utf8mb4 COLLATE utf8mb4_bin"
  end
end
